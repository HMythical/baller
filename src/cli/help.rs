...
const BUILTIN_COMMANDS: [BuiltinCommand; 10] = [
    BuiltinCommand {
        ...
        details: &["<PACKAGE_NAME>  Package to install"],
        notes: &[],
    },
    BuiltinCommand {
        name: "eject",
        summary: "Ejects (Uninstalls) a player from your team",
        usage: "baller eject <PACKAGE_NAME> [-y|--yes]",
        details: &[
    ...
    BuiltinCommand {
        ...
        details: &["<PACKAGE_NAME>  Package to pin at its current version"],
        notes: &[],
    },
    BuiltinCommand {
        name: "roster",
        ...
        details: &["[PACKAGE_NAME]  Package to look up; omit to list everything installed"],
        notes: &[],
    },
    BuiltinCommand {
        name: "substitute",
    ...
    BuiltinCommand {
        ...
        usage: "baller sweep [-y|--yes]",
        details: &["-y, --yes  Skip the confirmation prompt"],
        notes: &["Removes cached package archives; installed packages are left alone."],
    },
    BuiltinCommand {
        name: "update",
        ...
        usage: "baller update",
        details: &[],
        notes: &["Frozen packages are skipped."],
    },
    BuiltinCommand {
        name: "build",
        summary: "Builds a package natively from a local manifest",
        usage: "baller build <PATH>",
        details: &["<PATH>  Manifest (.toml or .json) to build from"],
        notes: &[],
    },
    BuiltinCommand {
        name: "inject",
...
mod tests {
    ...
    fn test_builtin_detail_without_arguments() {
        ...
        assert!(detail.contains("baller update"));
        assert!(detail.contains("Frozen packages are skipped."));
    }
